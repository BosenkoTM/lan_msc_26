...
| №  | Компонент                                              | Кол-во |
|----|--------------------------------------------------------|:------:|
| 1  | **Слаботочный щит навесной** (на 72 модуля)            | 1 шт.  |
...
| Запас (укладка 13+ UTP)  | ≈ 12 модулей            | —                          |
...
| Параметр       | Значение                                                          |
|----------------|-------------------------------------------------------------------|
| Тип            | Навесной слаботочный (мультимедийный) щит, металлический или пластиковый |
...
> 💡 Для слаботочки всегда выбирают щиты **с увеличенной глубиной 120+ мм** (вместо стандартных 90 мм для электрики) — 13 отходящих UTP-кабелей образуют толстый жгут и плохо переносят малые радиусы изгиба.
...
```text
┌──────────────────────────────────────────────────────────────────┐
│  ВЩ — Слаботочный щит навесной (72 модуля, глубина 130 мм)       │
├──────────────────────────────────────────────────────────────────┤
│                                                                  │
...
│  └────────────────────────────────────────────────────────────┘  │
│                                                                  │
│  ▸ Вывод кабелей снизу: 13× UTP-линий (3 розетки, 5 серверов,    │
...
| 4    | Компьютерная розетка **к3**                | Занят  |
| 5    | Сервер **серв_2(хранилище)**               | Занят  |
| 6    | Сервер **серв_3(основной)**                | Занят  |
| 7    | Сервер **серв_4(резерв)**                  | Занят  |
| 8    | Резерв                                     | Свободен|
...
| 8 | Свитч 1, порт 4               | Розетка к3                   | Компьютерная розетка        |
| 9 | Свитч 1, порт 5               | серв_2                       | Сервер                      |
| 10| Свитч 1, порт 6               | серв_3                       | Сервер                      |
| 11| Свитч 1, порт 7               | серв_4                       | Сервер                      |
| 12| Свитч 2, порт 2               | тв_1                         | LAN для ТВ 1                |
| 13| Свитч 2, порт 3               | тв_2                         | LAN для ТВ 2                |
| 14| Свитч 2, порт 4               | тв_3                         | LAN для ТВ 3                |
| 15| Свитч 2, порт 5               | серв_1                       | принтер                     |
```
